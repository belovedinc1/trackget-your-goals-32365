  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-8">
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-foreground">Welcome to Your Dashboard</h1>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">$0.00</div>
              <p className="text-xs text-muted-foreground">0 active goals</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Welcome to Trackget! Here you can track your expenses, manage savings goals, monitor EMIs, and much more.
              </p>
              <p className="text-sm text-muted-foreground">
                Features coming soon: Expense tracking, Savings goals, EMI management, Price monitoring, and AI-powered insights.
              </p>
            </CardContent>
          </Card>
        </div>
